(() => {
    ...
    const WORDS = [
        'good vibes', 'thank you', '✨', 'friendship', 'grateful', 'legend',
        'forever', 'always', 'you', 'me & you', 'appreciate you', 'homie'
    ];
    ...
    function startCardLoader() {
        ...
        const steps = [
            ...
            { threshold: 80, text: 'Generating love particles...' },
    ...
    const letterText = "Hey,\n\nI coded this little thing for you...\n\nEvery line of code, every pixel, and every beat is a reminder of how much your friendship means to me.\n\nNo matter where life takes us, I'm always glad to have you around, beating forever in the background of my code 💗.";
